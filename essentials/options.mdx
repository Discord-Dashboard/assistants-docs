...
Options are like the name suggest the options/values you can configure and make available on your dashboard. The options make use of the [Form Types](/essentials/formtypes.mdx)
